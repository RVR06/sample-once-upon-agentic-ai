...
builder.AddPythonApp("dice-roll-mcp", "../4_mcp_integration/", "dice_roll_mcp_server.py")
...
builder.AddPythonApp("character-agent", "../5_a2a_integration/agents/character_agent/", "character_agent.py")
    .WithVirtualEnvironment("../../../.venv")
    .WithEnvironment("AWS_DEFAULT_REGION", region)
    .WithEnvironment("AWS_ACCESS_KEY_ID", accessKeyId)
    .WithEnvironment("AWS_SECRET_ACCESS_KEY", secretAccessKey)
...
builder.AddPythonApp("rules-agent", "../5_a2a_integration/agents/rules_agent/", "rules_agent.py")
    .WithVirtualEnvironment("../../../.venv")
    .WithEnvironment("AWS_DEFAULT_REGION", region)
    .WithEnvironment("AWS_ACCESS_KEY_ID", accessKeyId)
    .WithEnvironment("AWS_SECRET_ACCESS_KEY", secretAccessKey)
...
// builder.AddExternalHttpEndpoints("character-ui")
//     .WithUrl("https://aws-samples.github.io/sample-once-upon-agentic-ai");
